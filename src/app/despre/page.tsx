...
const pillars = [
  { title: "Produse pe stoc", desc: "Livrare rapidă din București, oriunde în România." },
  { title: "Consultanță tehnică", desc: "Recomandări clare: produs + accesorii + pași de montaj." },
  { title: "Standard european", desc: "Certificări UE și calitate premium, gândite pentru durabilitate." },
]
...
export default function AboutPage() {
  return (
    <main className="bg-white">
      {/* HERO (fără absolute care poate “mânca” restul paginii) */}
      <section className="relative">
        <div className="relative h-[64vh] min-h-[520px] w-full overflow-hidden">
          <Image
            src="/about/hero.jpg"
        ...
        <div className="max-w-7xl mx-auto px-6 -mt-44 relative z-10">
          <div className="max-w-2xl rounded-2xl border border-white/15 bg-black/35 backdrop-blur-md p-8 md:p-10">
            <p className="text-white/75 text-sm tracking-wide uppercase">Despre TERAHAUS</p>
        ...
        {/* Spacer ca să nu intre următoarele secțiuni sub hero */}
        ...
        <div className="max-w-7xl mx-auto px-6 grid gap-10 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="mt-5 text-black/70 leading-relaxed">
              Suntem importator de soluții WPC premium: riflaje pentru interior și exterior, panouri
              pentru placări, deck, garduri și accesorii compatibile. Punem accent pe un rezultat curat,
              stabil și coerent — estetic și tehnic.
            </p>

            <div className="mt-8 grid gap-3">
              <div className="flex gap-3">
                <span className="mt-[7px] h-2 w-2 rounded-full bg-black/60" />
                <p className="text-black/70">Produse disponibile din stoc, București.</p>
              </div>
              <div className="flex gap-3">
                <span className="mt-[7px] h-2 w-2 rounded-full bg-black/60" />
                <p className="text-black/70">Consultanță + estimare necesar + recomandare accesorii.</p>
              </div>
              <div className="flex gap-3">
                <span className="mt-[7px] h-2 w-2 rounded-full bg-black/60" />
                <p className="text-black/70">Suport montaj + montaj prin parteneri.</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-xl border border-black/10 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
            <div className="relative aspect-[4/3]">
              <Image src="/about/detail.jpg" alt="Detaliu textură WPC" fill className="object-cover" />
        ...
        <div className="max-w-7xl mx-auto px-6 grid gap-10 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="mt-5 text-white/75 leading-relaxed">
              Avem depozit în București unde produsele pot fi vizionate, iar la cerere putem oferi mostre
              pentru a alege corect textura și nuanța.
            </p>

            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/contact" className="rounded-xl bg-white text-black px-5 py-3 text-sm font-medium hover:shadow transition">
                Cere mostre
              </Link>
              <Link href="/produse" className="rounded-xl border border-white/25 text-white px-5 py-3 text-sm font-medium hover:border-white/50 transition">
                Vezi produsele
              </Link>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-xl border border-white/10">
            <div className="relative aspect-[4/3]">
              <Image src="/about/warehouse.jpg" alt="Depozit TERAHAUS" fill className="object-cover opacity-90" />
