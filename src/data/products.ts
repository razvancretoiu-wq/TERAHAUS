...
export const products: Product[] = [
  {
    ...
    image: "/p1.jpg",
    badge: "Popular",
    short: "Riflaj WPC premium, finisaj elegant, potrivit pentru interior și exterior.",
    features: ["Rezistență UV", "Întreținere ușoară", "Montaj rapid"],
  },
  {
    title: "Riflaj WPC Premium – Grafit",
    slug: "riflaj-wpc-grafit",
    category: "riflaje",
    image: "/p2.jpg",
    short: "Aspect modern, ideal pentru fațade și accente arhitecturale.",
    features: ["Aspect modern", "Rezistent la intemperii", "Stabilitate dimensională"],
  },
  {
    title: "Deck WPC – Teak",
    slug: "deck-wpc-teak",
    ...
    image: "/p3.jpg",
    badge: "Nou",
    short: "Deck cu look natural, antiderapant, potrivit pentru terase premium.",
    features: ["Antiderapant", "Durabil", "Rezistență la umezeală"],
  },
  {
